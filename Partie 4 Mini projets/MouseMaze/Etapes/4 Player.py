...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Maze Mouse Game - Étape 4")
    ...
    # --- AJOUTÉ À L'ÉTAPE 4 : Fonction reset_level pour replacer le curseur au départ ---
    ...
    def run(self):
        ...
        while running:
            ...
            # --- AJOUTÉ À L'ÉTAPE 4 : Vérification des collisions et réinitialisation ---
            if self.current_level.check_collision(player_pos):
                self.reset_level()

            # --- Gestion de la progression : si le joueur atteint la sortie, passe au niveau suivant ---
